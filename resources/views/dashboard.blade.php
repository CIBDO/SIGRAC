                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12 mt-5">
                            <h3 class="page-title mt-3">Bienvenue <span>{{ auth()->user()->name }}</span>
                            </h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card board1 fill">
                            <div class="card-body">
                                ...
                                <div>
                                        ...
                                        <h3 class="text-muted">Régisseurs </h3>
                                    </div>
                                    <div class="ml-auto mt-md-3 mt-lg-0"> 
                                    <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    <div>
                                        ...
                                        <h6 class="text-muted">Comptables</h6>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    <div>
                                        ...
                                        <h6 class="text-muted">Nominations</h6>
                                    </div>
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="card card-table flex-fill">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-primary float-right veiwbutton">voir tous</button>
                            </div>
                            <div class="card-body">
